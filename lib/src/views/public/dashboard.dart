...
import 'package:univents/src/views/public/view_all_organization_page.dart';
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ViewAllOrganizationsPage(organizations: []),
                        ),
                      );
                    },
                    child: const Text(
              ...
              FutureBuilder<List<OrganizationCard>>(
                ...
                builder: (context, organizationSnapshot) {
                  if (organizationSnapshot.connectionState == ConnectionState.waiting) {
                    ...
                    final organizations = organizationSnapshot.data!;
                    final limitedOrganizations = organizations.take(10).toList();
